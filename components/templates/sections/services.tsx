...
function Services() {
    ...
    return (
        <section aria-labelledby="services-conatiner" className='services__container bg-slate-900/40 py-10 flex flex-col border-slate-800/40 lg:px-8 mt-25 md:mt-50'>
