...
function ToolCard({ icon, name }: ToolCard) {
    return (
        <div className={cn("tool-card__container w-[calc(50%-12px)]",
            "w-30",
            "md:w-50 flex gap-y-4 flex-col shrink-0 p-4 md:p-8 items-center bg-[rgba(17,23,38,0.7)] border-[rgba(255,255,255,0.05)] border backdrop-blur-md hover:bg-slate-800/60 rounded-md"
        )}>
